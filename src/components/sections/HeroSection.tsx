    ...
    <Section id="hero" depth={1} className="!py-0">
      <div ref={heroRef} className="relative min-h-screen overflow-hidden">
        ...
        <div className="hero-bg-effects absolute inset-0 z-0 will-change-transform">
          ...
          {/* Accent lines */}
          <div className="absolute top-[18%] right-0 h-px w-[35%] bg-gradient-to-l from-transparent via-orange/15 to-transparent" />
          <div className="absolute bottom-[28%] left-0 h-px w-[30%] bg-gradient-to-r from-transparent via-slate/25 to-transparent" />
          <div className="absolute top-[50%] right-[10%] h-[20%] w-px bg-gradient-to-b from-transparent via-slate/15 to-transparent" />
        </div>

        <div className="absolute inset-0 z-[1]"><Scene3D /></div>

        {/* ===== CONTENT ===== */}
        <div className="relative z-10 flex min-h-screen items-center px-4 tablet:px-8">
            ...
            <div className="grid grid-cols-1 gap-12 desktop:grid-cols-[1.2fr_1fr] desktop:items-center desktop:gap-16">
              ...
              <div className="hero-text-content">
                <div>
                  ...
                  <p className="hero-title mb-7 font-nav text-base tracking-wider text-slate-light tablet:text-lg">
                    AI/ML Engineer <span className="text-orange">&bull;</span> Data Scientist
                  </p>
                  <p className="hero-about mb-9 max-w-lg text-base leading-relaxed text-cream/65">
